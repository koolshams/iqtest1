...
module.exports = class Action_itemsService {
  ...
  static async bulkImport(req, res, sendInvitationEmails = true, host) {
    ...
    try {
      ...
      await Action_itemsDBApi.bulkImport(results, {
        transaction,
  ...
  static async update(data, id, currentUser) {
    ...
    try {
      ...
      const updatedAction_items = await Action_itemsDBApi.update(id, data, {
        currentUser,
        transaction,
      });

      await transaction.commit();
      return updatedAction_items;
    } catch (error) {
      await transaction.rollback();
      throw error;
    }
  ...
  static async deleteByIds(ids, currentUser) {
    ...
    try {
      await Action_itemsDBApi.deleteByIds(ids, {
        currentUser,
        transaction,
      });
