...
module.exports = class UsersDBApi {
  static async create(data, globalAccess, options) {
    ...
    await users.setCompany(data.data.company || null, {
      transaction,
    });
  ...
  static async update(id, data, globalAccess, options) {
    ...
    await users.setCompany(data.company || null, {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.counselors_user = await users.getCounselors_user({
      transaction,
    });
    ...
    output.company = await users.getCompany({
      transaction,
    });
