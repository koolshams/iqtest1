...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: 'a51b6e487dd52b55903ce34afe7cf9d5',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'iqtest1 <app@flatlogic.app>',
  ...
  project_uuid: '49edac6c-8cfd-4013-a7dc-c3ee39353b8e',
  flHost:
...
config.pexelsQuery = 'calm ocean waves';
config.host =
