    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Counselors User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.counselors_user &&
                      Array.isArray(users.counselors_user) &&
                      users.counselors_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(
          ...
          <>
            <p className={'block font-bold mb-2'}>Parents User</p>
            <CardBox
              className='mb-6 border border-gray-300 rounded overflow-hidden'
              hasTable
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.parents_user &&
                      Array.isArray(users.parents_user) &&
                      users.parents_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
