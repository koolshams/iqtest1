...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/colleges/collegesSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureCollegesCols';
...
const TableSampleColleges = ({
  ...
  const {
    ...
    loading,
    count,
    notify: collegesNotify,
    refetch,
  } = useAppSelector((state) => state.colleges);
  ...
  useEffect(() => {
    if (collegesNotify.showNotification) {
      notify(collegesNotify.typeNotification, collegesNotify.textNotification);
    }
  }, [collegesNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/colleges/colleges-view/?id=${id}`);
  };
...
export default TableSampleColleges;
