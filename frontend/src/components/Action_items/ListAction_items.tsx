...
const ListAction_items = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_ACTION_ITEMS');
            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/action_items/action_items-edit/?id=${item.id}`}
                  pathView={`/action_items/action_items-view/?id=${item.id}`}
                  hasUpdatePermission={hasUpdatePermission}
                />
              </div>
            </CardBox>
          ))}
        {!loading && action_items.length === 0 && (
...
export default ListAction_items;
