              ...
              >
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>
                      {dataFormatter
                        .action_itemsManyListFormatter(item.action_items)
                        .join(', ')}
                    </p>
                  </div>
                  ...
                  <div className={'flex-1 px-3'}>
                    ...
                    <p className={'line-clamp-2'}>
                      {dataFormatter
                        .sessionsManyListFormatter(item.sessions)
                        .join(', ')}
                    </p>
                  </div>

                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs   text-gray-500 '}>MyColleges</p>
                    <p className={'line-clamp-2'}>
                      {dataFormatter
                        .my_collegesManyListFormatter(item.my_colleges)
                        .join(', ')}
                    </p>
                  </div>
                </div>
